...
<head>
        ...
        <title>Team Management - Coordinator</title>
        ...
        <main class="ml-64 flex flex-col min-h-screen">
                ...
                <div class="flex-1 p-8">
                        <div class="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center mt-12">
                                <span class="material-symbols-outlined text-6xl text-gray-300 mb-4">diversity_3</span>
                                <h3 class="text-xl font-bold text-gray-800 mb-2">Team Management Module</h3>
                                <p class="text-gray-500">This module is currently under development.</p>
                                <p class="text-sm text-gray-400 mt-2">Manage Mentors, Teams, and Workloads here.</p>
                        </div>
                </div>
        </main>
</body>
