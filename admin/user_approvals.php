                  ...
                  <?php foreach ($pending_users as $user): ?>
                    <tr class="hover:bg-gray-50/50">
                      ...
                      <td class="px-6 py-4 text-right space-x-2 flex justify-end">
                        <form method="POST" action="user_approvals.php" class="inline">
                        ...
                        <form method="POST" action="user_approvals.php" class="inline" onsubmit="return confirm('Are you sure you want to reject this user?');">
