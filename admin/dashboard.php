      ...
      <div class="relative mr-1" id="notifications-container-menu">
          ...
          <div id="notifications-dropdown" class="hidden absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-lg py-2 z-50">
              <div class="px-4 py-2 border-b border-gray-100 flex items-center justify-between">
                  ...
                  <?php if ($admin_unread_count > 0): ?>
                      <a href="../mark_notification_read.php?action=read_all&redirect=dashboard.php" class="text-[10px] font-bold text-blue-600 hover:text-blue-800">Mark all read</a>
                  <?php endif; ?>
              </div>
              ...
              <div class="border-t border-gray-100 pt-1 text-center">
                  <a href="/IMP/admin/notifications.php" class="block py-2 text-xs font-bold text-blue-600 hover:text-blue-800">View all notifications</a>
              </div>
          </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex flex-wrap gap-3">
            <button onclick="window.location.href='users.php'" class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium hover:bg-gray-50 hover:shadow-md transition-all shadow-sm cursor-pointer">
              <span class="material-symbols-outlined text-lg">person_add</span> Manage Users
            </button>
            <button onclick="window.location.href="/IMP/admin/notifications.php?tab=compose"" class="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium hover:bg-blue-700 hover:shadow-md transition-all shadow-sm cursor-pointer">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm stat-card">
            ...
            <p class="text-3xl font-black text-gray-900 mt-1">
              <a href="student_reports.php" class="text-red-600 hover:text-red-700"><?php echo $pending_reports_count; ?></a>
            </p>
          </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mt-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <a href="student_reports.php" class="text-sm font-semibold text-blue-600 hover:text-blue-700">View All Reports →</a>
          </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div class="bg-white rounded-xl border border-gray-200 shadow-sm lg:col-span-2 hover:shadow-md transition-shadow">
            <div class="p-5 border-b border-gray-100 flex justify-between items-center">
              ...
              <a href="users.php" class="text-blue-600 text-xs font-bold hover:underline">View All Users</a>
            </div>
          ...
          <div class="bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col hover:shadow-md transition-shadow">
            ...
            <div class="p-4 border-t border-gray-100 flex flex-col gap-2 mt-auto">
              <button onclick="window.location.href="/IMP/admin/student_logs.php'"" class="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 rounded-lg text-xs font-bold transition-colors cursor-pointer">
