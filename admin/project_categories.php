      ...
      <div class="bg-white border border-gray-200 rounded-3xl shadow-sm p-6">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div class="flex flex-wrap gap-2">
            <a href="project_categories.php?tab=types" class="px-4 py-2 rounded-full text-xs font-bold <?php echo $active_tab === 'types' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-700'; ?>">Manage Project Types</a>
            <a href="project_categories.php?tab=subtypes" class="px-4 py-2 rounded-full text-xs font-bold <?php echo $active_tab === 'subtypes' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-700'; ?>">Manage Project Subtypes</a>
          </div>
        </div>
        ...
        <?php if ($active_tab === 'types'): ?>
          <div class="mt-8 grid gap-6 lg:grid-cols-[360px_1fr]">
            <div class="border border-gray-200 rounded-3xl bg-slate-50 p-6">
              ...
              <form method="POST" action="project_categories.php?tab=types" class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-2">
                  <?php if (!empty($edit_type)): ?>
                    <a href="project_categories.php?tab=types" class="rounded-2xl border border-gray-200 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-gray-100">Cancel</a>
                  <?php endif; ?>
                  ...
                  <?php foreach ($project_types as $type): ?>
                    <tr>
                      ...
                      <td class="px-4 py-4 text-right space-x-2 whitespace-nowrap">
                        <a href="project_categories.php?tab=types&edit_type_id=<?php echo (int)$type['id']; ?>" class="text-blue-600 hover:text-blue-800 text-xs font-semibold">Edit</a>
                        <a href="project_categories.php?tab=types&action=toggle_type&id=<?php echo (int)$type['id']; ?>&status=<?php echo $type['status'] === 'Active' ? 'Inactive' : 'Active'; ?>" class="text-slate-700 hover:text-slate-900 text-xs font-semibold"><?php echo $type['status'] === 'Active' ? 'Deactivate' : 'Activate'; ?></a>
                        <a href="project_categories.php?tab=types&action=delete_type&id=<?php echo (int)$type['id']; ?>" onclick="return confirm('Delete this type and all its subtypes?');" class="text-red-600 hover:text-red-800 text-xs font-semibold">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
        ...
        <?php else: ?>
          <div class="mt-8 grid gap-6 lg:grid-cols-[360px_1fr]">
            <div class="border border-gray-200 rounded-3xl bg-slate-50 p-6">
              ...
              <form method="POST" action="project_categories.php?tab=subtypes" class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-2">
                  <?php if (!empty($edit_subtype)): ?>
                    <a href="project_categories.php?tab=subtypes" class="rounded-2xl border border-gray-200 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-gray-100">Cancel</a>
                  <?php endif; ?>
                ...
                <tbody class="divide-y divide-gray-100">
                  <?php foreach ($project_subtypes as $subtype): ?>
                    <tr>
                      ...
                      <td class="px-4 py-4 text-right space-x-2 whitespace-nowrap">
                        <a href="project_categories.php?tab=subtypes&edit_subtype_id=<?php echo (int)$subtype['id']; ?>" class="text-blue-600 hover:text-blue-800 text-xs font-semibold">Edit</a>
                        <a href="project_categories.php?tab=subtypes&action=toggle_subtype&id=<?php echo (int)$subtype['id']; ?>&status=<?php echo $subtype['status'] === 'Active' ? 'Inactive' : 'Active'; ?>" class="text-slate-700 hover:text-slate-900 text-xs font-semibold"><?php echo $subtype['status'] === 'Active' ? 'Deactivate' : 'Activate'; ?></a>
                        <a href="project_categories.php?tab=subtypes&action=delete_subtype&id=<?php echo (int)$subtype['id']; ?>" onclick="return confirm('Delete this subtype?');" class="text-red-600 hover:text-red-800 text-xs font-semibold">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
