...
// Completed reviews (feedback entries by this mentor)
$completed_sql = "SELECT COUNT(*) AS cnt FROM daily_logs dl JOIN mentor_assignments ma ON ma.student_id = dl.user_id WHERE ma.mentor_id = $mentor_id AND ma.status = 'active'";
