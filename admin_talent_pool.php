        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex gap-3 flex-wrap">
                    ...
                    <a href="admin_talent_pool.php" class="<?php echo !$show_all ? 'bg-blue-600 text-white' : 'bg-white border border-gray-300 text-gray-700'; ?> px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium hover:shadow-md transition-all shadow-sm cursor-pointer">
            ...
            <!-- Search & Filters -->
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                <form method="GET" action="admin_talent_pool.php" class="space-y-4" id="filter-form">
                    <?php if ($show_all): ?>
                    ...
                    <div class="flex flex-col md:flex-row gap-3">
                        ...
                        <a href="admin_talent_pool.php<?php echo $show_all ? '?show_all=1' : ''; ?>" class="bg-gray-100 text-gray-700 px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-200 transition-colors flex items-center gap-2 cursor-pointer">
            ...
            <div id="card-view" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm talent-card <?php echo $is_featured ? 'featured-glow border-yellow-300' : ''; ?> relative overflow-hidden">
                    ...
                    <div class="px-5 pb-5 flex flex-wrap gap-2">
                        ...
                        <!-- Feature Toggle -->
                        <form method="POST" action="admin_talent_pool.php<?php echo $show_all?'?show_all=1':''; ?>" class="flex-1">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors <?php echo $is_featured ? 'bg-yellow-50/30' : ''; ?>">
                                    ...
                                    <td class="px-5 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <form method="POST" action="admin_talent_pool.php<?php echo $show_all?'?show_all=1':''; ?>" class="inline">
                                                <input type="hidden" name="action" value="toggle_featured">
                                                <input type="hidden" name="app_id" value="<?php echo $app_id; ?>">
...
<div id="placement-modal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center modal-overlay p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form method="POST" action="admin_talent_pool.php<?php echo $show_all?'?show_all=1':''; ?>" class="p-6 space-y-4">
