...
<span class="material-symbols-outlined text-sm" data-icon="lock">lock</span>
<span class="font-label-sm text-label-sm">Your data is securely protected</span>
</div><p class="text-center font-body-md text-body-md text-on-surface-variant mt-2">Don't have an account? <a class="text-primary font-label-md hover:underline" href="registration_page.html">Sign Up</a></p>
</div>
</div>
</div>
</main>
