      ...
      <div class="space-y-6">
        <div>
          ...
          <nav class="flex flex-col gap-1">
            ...
            <a href="admin_reports.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-4 py-2.5 rounded-r-lg text-sm font-bold">
      ...
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div class="flex gap-2">
            <a href="admin_reports.php?export=users" class="bg-white border border-gray-200 text-slate-700 px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-bold shadow-sm hover:bg-gray-50">
              <span class="material-symbols-outlined text-sm">download</span> Users CSV
            </a>
            <a href="admin_reports.php?export=placements" class="bg-white border border-gray-200 text-slate-700 px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-bold shadow-sm hover:bg-gray-50">
              <span class="material-symbols-outlined text-sm">download</span> Placements CSV
            </a>
            <a href="admin_reports.php?export=logs" class="bg-white border border-gray-200 text-slate-700 px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-bold shadow-sm hover:bg-gray-50">
