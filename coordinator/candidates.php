...
<body class="bg-gray-100 text-gray-800">
        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-white border-r border-gray-200 flex flex-col py-6">
                ...
                <nav class="flex-1 space-y-0.5 px-3">
                        ...
                        <a href="/IMP/coordinator/candidates.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-3 py-2.5 rounded-r-lg text-sm font-semibold">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <div class="flex-1 p-8 space-y-6">
                        ...
                        <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            <form method="GET" action="/IMP/coordinator/candidates.php" class="flex flex-col md:flex-row gap-3 items-stretch md:items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <?php if (!empty($search) || !empty($status_filter)): ?>
                                        <a href="/IMP/coordinator/candidates.php" class="bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 px-3 py-2 rounded-lg text-xs font-bold flex items-center justify-center">Reset</a>
                                    <?php endif; ?>
                                </div>
                            </form>
                        </div>
                                                         ...
                                                         <tr class="hover:bg-gray-50 transition-colors">
                                                                 ...
                                                                 <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                                                         ...
                                                                         <?php if (in_array($app['status'], ['Selected', 'Started', 'Internship Started', 'Active Intern', 'Completed'])): ?>
                                                                             <a href="/IMP/coordinator/daily_logs.php?search=<?php echo urlencode($app['student_name'] ?? ''); ?>" class="inline-block text-emerald-600 hover:text-emerald-800 font-bold text-xs bg-emerald-50 px-2.5 py-1.5 rounded-lg border border-emerald-200 hover:bg-emerald-100 transition-colors">Monitor Progress</a>
                                                                         <?php endif; ?>
