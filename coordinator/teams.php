...
@include_once __DIR__ . '/../includes/ensure_extended_schema.php';
...
<body class="bg-gray-100 text-gray-800">
        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-white border-r border-gray-200 flex flex-col py-6">
                ...
                <nav class="flex-1 space-y-0.5 px-3">
						...
						<a href="/IMP/coordinator/teams.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-3 py-2.5 rounded-r-lg text-sm font-semibold">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                    <form method="GET" action="/IMP/coordinator/teams.php" class="flex gap-2">
                        ...
                        <?php if (!empty($search)): ?>
                            <a href="/IMP/coordinator/teams.php" class="bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 px-4 py-2 rounded-lg text-xs font-bold flex items-center justify-center">Reset</a>
                        <?php endif; ?>
                    </form>
                </div>
                            ...
                            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow gap-5">
                                ...
                                <div class="pt-4 border-t border-gray-100 flex flex-col gap-2 mt-auto">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <form method="POST" action="/IMP/coordinator/teams.php" onsubmit="return confirm('Are you sure you want to delete and dissolve this project team?');" class="flex-1">
    ...
    <div id="team-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form method="POST" action="/IMP/coordinator/teams.php" id="team-form" class="p-8 space-y-4 max-h-[70vh] overflow-y-auto">
    ...
    <div id="message-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-[60] hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form method="POST" action="/IMP/coordinator/teams.php" id="message-form" class="p-8 space-y-5">
