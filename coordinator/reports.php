...
<body class="bg-gray-100 text-gray-800">
        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-white border-r border-gray-200 flex flex-col py-6 no-print">
                ...
                <nav class="flex-1 space-y-0.5 px-3">
                        ...
                        <a href="/IMP/coordinator/reports.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-3 py-2.5 rounded-r-lg text-sm font-semibold">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
                        ...
                        <form method="GET" action="/IMP/coordinator/reports.php" class="flex gap-2">
                            ...
                            <?php if (!empty($search)): ?>
                                <a href="/IMP/coordinator/reports.php" class="bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 px-3 py-1.5 rounded-lg text-xs font-bold flex items-center justify-center">Reset</a>
						<?php endif; ?>
                        </form>
                    </div>
