        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-gray-50 border-r border-gray-200 flex flex-col py-6 font-sans text-sm font-medium">
                ...
                <nav class="flex-1 space-y-1">
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/dashboard.php">
                                <span class="material-symbols-outlined">dashboard</span>
                                <span>Dashboard</span>
                        </a>
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/internships.php">
                                <span class="material-symbols-outlined">work</span>
                                <span>Postings</span>
                        </a>
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/candidates.php">
                                <span class="material-symbols-outlined">group</span>
                                <span>Candidates</span>
                        </a>

                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/daily_logs.php">
                                <span class="material-symbols-outlined">monitoring</span>
                                <span>Daily Logs Monitoring</span>
                        </a>
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/reports.php">
                                <span class="material-symbols-outlined">analytics</span>
                                <span>Reports</span>
                        </a>
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/teams.php">
                ...
                <div class="mt-auto border-t border-gray-200 pt-4">
                        <a class="flex items-center gap-3 text-gray-600 px-4 py-3 hover:bg-gray-100 duration-200 ease-in-out"
                                href="/IMP/coordinator/help_center.php">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <div class="flex-1 p-8 space-y-6">
                                <div class="bg-white p-12 rounded-xl shadow-sm border border-gray-200 text-center mt-12">
                                        ...
                                        <p class="text-sm text-gray-400 mt-2">Use the <a href="/IMP/coordinator/dashboard.php" class="text-blue-600 hover:underline font-bold">Dashboard</a> or <a href="/IMP/coordinator/internships.php" class="text-blue-600 hover:underline font-bold">Postings</a> page to manage projects.</p>
                                </div>
                        </div>
                </main>
                <script>
