...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'review') {
    ...
    if ($log_data = mysqli_fetch_assoc($fetch_res)) {
        ...
        if (mysqli_stmt_execute($update_stmt)) {
            ...
            header("Location: /IMP/coordinator/daily_logs.php?success=" . urlencode("Daily log reviewed successfully!"));
            exit();
        } else {
...
<body class="bg-gray-100 text-gray-800">
        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-white border-r border-gray-200 flex flex-col py-6">
                ...
                <nav class="flex-1 space-y-0.5 px-3">
                        ...
                        <a href="/IMP/coordinator/daily_logs.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-3 py-2.5 rounded-r-lg text-sm font-semibold">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <!-- Filters -->
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    <form method="GET" action="/IMP/coordinator/daily_logs.php" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="space-y-1">
                        ...
                        <div class="space-y-1 flex flex-col justify-between">
                            <div class="flex-1 space-y-1">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="/IMP/coordinator/daily_logs.php" class="bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 px-3 py-2 rounded-lg text-xs font-bold flex items-center justify-center">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div id="log-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div class="p-6 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
                ...
                <form id="modal-review-form" method="POST" action="/IMP/coordinator/daily_logs.php">
