...
<body class="bg-gray-100 text-gray-800">
        ...
        <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-white border-r border-gray-200 flex flex-col py-6">
                ...
                <div class="border-t border-gray-200 pt-3 px-3 space-y-0.5">
                        <a href="/IMP/coordinator/profile.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-3 py-2.5 rounded-r-lg text-sm font-semibold">
                ...
                <div class="flex-1 p-8 space-y-6 max-w-4xl mx-auto w-full">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div class="border-b border-gray-200 px-8 flex gap-6">
                                        <a href="/IMP/coordinator/profile.php?section=profile" class="py-4 border-b-2 font-semibold text-sm transition-colors cursor-pointer <?php echo $section === 'profile' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'; ?>">
                                                Account Details
                                        </a>
                                        <a href="/IMP/coordinator/profile.php?section=settings" class="py-4 border-b-2 font-semibold text-sm transition-colors cursor-pointer <?php echo $section === 'settings' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'; ?>">
                                                Security Settings
                                        </a>
                                </div>
                                ...
                                <div class="p-8">
                                        <?php if ($section === 'profile'): ?>
                                                <form action="/IMP/coordinator/profile.php?section=profile" method="POST" enctype="multipart/form-data" class="space-y-6">
                                        ...
                                        <?php elseif ($section === 'settings'): ?>
                                                <form action="/IMP/coordinator/profile.php?section=settings" method="POST" class="space-y-6 max-w-md">
        ...
        document.addEventListener('DOMContentLoaded', function() {
                // Sidebar Toggle
                const passwordForm = document.querySelector('form[action="/IMP/coordinator/profile.php"]');
