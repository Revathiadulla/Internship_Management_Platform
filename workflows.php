...
page_shell_start('workflows', 'Workflows', 'Configure the application pipeline and update candidate statuses.', '<a href="archived_applications.php" class="inline-flex items-center gap-2 bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-slate-50 transition-all"><span class="material-symbols-outlined">archive</span> Archived Applications</a>');
?>
