...
<body class="min-h-screen flex flex-col font-sans antialiased">
      ...
      <div class="space-y-6">
        <div>
          ...
          <nav class="flex flex-col gap-1">
            ...
            <a href="admin_daily_logs.php" class="flex items-center gap-3 bg-blue-50 text-blue-700 border-l-4 border-blue-600 px-4 py-2.5 rounded-r-lg text-sm font-bold">
    ...
    <main class="flex-1 p-8 overflow-y-auto bg-gray-50">
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
          <form method="GET" action="admin_daily_logs.php" class="grid grid-cols-1 md:grid-cols-5 gap-3 items-center">
            ...
            <div class="flex gap-2 justify-end w-full">
              ...
              <?php if (!empty($search) || !empty($status_filter) || !empty($focus_filter) || !empty($date_start) || !empty($date_end)): ?>
                <a href="admin_daily_logs.php" class="bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-700 px-4 py-2 rounded-lg text-xs font-bold flex items-center justify-center transition-colors">Reset</a>
              <?php endif; ?>
            </div>
          </form>
        </div>
  ...
  <div id="review-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
      ...
      <div class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
        ...
        <form method="POST" action="admin_daily_logs.php" class="pt-4 border-t border-gray-150 space-y-3">
  ...
  <script>
    async function reviewLog(logId) {
      try {
        const response = await fetch(`admin_daily_logs.php?action=get_log_details&id=${logId}`);
