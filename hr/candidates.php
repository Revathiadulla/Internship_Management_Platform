        ...
        <?php if ($result && $total_rows > 0): while ($row = mysqli_fetch_assoc($result)): ?>
            <tr class="hover:bg-slate-50/50 transition-colors">
                ...
                <td class="px-8 py-4 text-right">
                    <a class="inline-flex items-center gap-1 font-semibold text-blue-700 hover:text-blue-900 transition-colors hover:underline" href="applicant_detail.php?app_id=<?php echo (int) $row['latest_application_id']; ?>">
