...
<body class="bg-[#f8f9fa] text-[#111827] antialiased">
  <aside class="fixed left-0 top-0 h-screen w-60 z-50 bg-gray-50 border-r border-gray-200 flex flex-col py-6 text-sm font-medium">
    ...
    <nav class="flex-1 flex flex-col gap-1 px-4">
      <a href="dashboard.php" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-100 transition"> <span class="material-symbols-outlined">dashboard</span> Dashboard</a>
      <a href="applications.php" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-100 transition"> <span class="material-symbols-outlined">assignment</span> Applications</a>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <form method="get" class="grid gap-4 xl:grid-cols-5">
          ...
          <div class="flex items-end gap-2">
            ...
            <a href="pipeline.php" class="w-full text-center border border-slate-200 rounded-lg px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 transition">Reset</a>
          </div>
        </form>
      </div>
                ...
                <?php foreach ($pipeline[$column_status] as $item): ?>
                  <div class="pipeline-card" 
                    ...
                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-slate-100">
                      <a href="applicant_detail.php?app_id=<?php echo $item['app_id']; ?>" class="text-[11px] font-semibold text-blue-600 hover:text-blue-700 hover:underline">
                        View Profile
                      </a>
