...
<body class="bg-gray-100 text-gray-800">
        ...
        <main class="ml-60 flex flex-col min-h-screen">
                ...
                <div class="flex-1 p-8 space-y-8 max-w-6xl mx-auto w-full">
                        <!-- Toasts -->
                        <?php if ($success_msg): ?>
                            <div id="toast-success" class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 border border-green-200 flex items-center gap-2 animate-pulse">
                        ...
                        <?php if ($error_msg): ?>
                            <div id="toast-error" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 border border-red-200 flex items-center gap-2 animate-pulse">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <section id="quick-guide" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-6 scroll-mt-24 help-section">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_internships.php'" class="mt-3 text-xs font-bold text-blue-600 hover:text-blue-800 flex items-center gap-1">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_candidates.php'" class="mt-3 text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center gap-1">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_teams.php'" class="mt-3 text-xs font-bold text-purple-600 hover:text-purple-800 flex items-center gap-1">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_internships.php'" class="mt-3 text-xs font-bold text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_daily_logs.php'" class="mt-3 text-xs font-bold text-amber-600 hover:text-amber-800 flex items-center gap-1">
                                        ...
                                        <div class="p-4 bg-slate-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-colors">
                                            ...
                                            <button onclick="window.location.href='coordinator_reports.php'" class="mt-3 text-xs font-bold text-red-600 hover:text-red-800 flex items-center gap-1">
                            ...
                            <div class="space-y-8">
                                ...
                                <section class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                                    ...
                                    <form action="coordinator_help_center.php" method="POST" enctype="multipart/form-data" class="space-y-4">
