        ...
        if ($request && $request['status'] === 'Pending') {
            ...
            try {
                if ($action === 'approve') {
                    ...
                    $m_type = 'success';
                    $m_link = $team_id > 0 ? "mentor_workspace.php?team_id=" . $team_id . "&tab=students" : "mentor_dashboard.php";
                      ...
                      <td class="px-6 py-4 text-right space-x-2">
                        <?php if ($req['status'] === 'Pending'): ?>
                          <div class="flex items-center justify-end gap-3">
                            <form method="POST" action="admin_dropout_requests.php" class="inline" onsubmit="return confirm('Are you sure you want to approve this dropout request?');">
                            ...
                            <form method="POST" action="admin_dropout_requests.php" class="inline" onsubmit="return confirm('Are you sure you want to reject this dropout request?');">
