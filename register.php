...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        if ($role === 'company') {
            $comp_name_fallback = $full_name . ' Inc.';
            mysqli_query($conn, "INSERT INTO company_profiles (user_id, company_name) VALUES ($user_id, '" . mysqli_real_escape_string($conn, $comp_name_fallback) . "')");
        }
