...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <?php endif; ?>
                ...
                <div class="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                    <form method="GET" action="daily_logs.php" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        <div>
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                        <form method="GET" action="daily_logs.php" class="relative w-full max-w-sm">
                        ...
                        <a href="daily_logs.php" class="text-xs text-blue-600 font-bold hover:underline">Clear Filters</a>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="mt-8 pt-6 border-t border-gray-100 flex flex-wrap gap-3 items-center">
                                        ...
                                        <?php if ($log['status'] === 'Submitted'): ?>
                                            <form action="daily_logs.php" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to quick-approve this log submission? Status will be set to Approved and rating will be 5 stars.');">
                                        ...
                                        <form action="daily_logs.php" method="POST" class="inline" onsubmit="return confirm('Send a log submission reminder notification to this student?');">
                                            <?php echo csrf_token_field(); ?>
                    ...
                    <?php
                    $params = $_GET;
                    echo module_pagination($total_rows, $limit, $page, 'daily_logs.php', $params);
                    ?>
                </div>
    ...
    <div id="review-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-150">
            ...
            <form action="daily_logs.php" method="POST" class="p-6 space-y-4" onsubmit="return confirm('Submit this evaluation and notify the intern?');">
                <?php echo csrf_token_field(); ?>
    ...
    <script>
        ...
        async function viewHistory(studentId, studentName) {
            ...
            try {
                const response = await fetch(`daily_logs.php?ajax_action=history&student_id=${studentId}`);
