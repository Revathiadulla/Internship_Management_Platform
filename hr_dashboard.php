...
if ($status_res) {
    while ($row = mysqli_fetch_assoc($status_res)) {
        ...
        // Map legacy exam statuses to Exam Mail Sent
        if (in_array($st, ['Exam Completed', 'Test Completed', 'Test Submitted', 'Test Passed', 'Test Failed', 'Qualified', 'Not Qualified'], true)) {
            $st = 'Exam Mail Sent';
        }
...
$exam_sent_count   = $status_counts['Exam Mail Sent'] ?? 0;
...
<div class="mb-8 rounded-2xl bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-800 p-6 md:p-8 text-white shadow-md relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div class="flex flex-wrap gap-3 shrink-0">
            <a href="hr_applications.php" class="bg-white text-indigo-900 px-4 py-2.5 rounded-xl text-sm font-bold shadow-sm hover:shadow-md hover:bg-indigo-50 transition flex items-center gap-2">
                <i class="fas fa-file-invoice"></i> Applications
            </a>
            <a href="hr_applications.php?status=Shortlisted" class="bg-indigo-600 border border-indigo-500 text-white px-4 py-2.5 rounded-xl text-sm font-bold shadow-sm hover:shadow-md hover:bg-indigo-500/85 transition flex items-center gap-2">
...
<div class="mt-8">
    ...
    <div class="grid gap-5 grid-cols-2 md:grid-cols-4 xl:grid-cols-8">
        <!-- Applied -->
        <a href="hr_applications.php?status=Applied" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-blue-200 transition duration-150 flex flex-col justify-between">
        ...
        <!-- Shortlisted -->
        <a href="hr_applications.php?status=Shortlisted" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-orange-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
        ...
        <!-- Exam Mail Sent -->
        <a href="hr_applications.php?status=Exam+Mail+Sent" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-purple-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
                <div class="bg-purple-50 text-purple-600 p-2 rounded-xl text-sm shrink-0">
                    <i class="fas fa-envelope"></i>
                </div>
                <span class="text-[10px] font-bold text-purple-600 tracking-wider">Exam Sent</span>
            </div>
            <div class="mt-4">
                <p class="text-2xl font-black text-slate-800"><?php echo number_format($exam_sent_count); ?></p>
            </div>
        </a>

        <!-- HOD Pending -->
        <a href="hr_applications.php?status=HOD+Pending" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-orange-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
                <div class="bg-orange-50 text-orange-600 p-2 rounded-xl text-sm shrink-0">
        ...
        <!-- HR Review -->
        <a href="hr_applications.php?status=HR+Review" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-indigo-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
        ...
        <!-- HOD Approved -->
        <a href="hr_applications.php?status=HOD+Approved" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-teal-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
        ...
        <!-- Selected -->
        <a href="hr_applications.php?status=Selected" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-green-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
        ...
        <!-- Rejected -->
        <a href="hr_applications.php?status=Rejected" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-red-200 transition duration-150 flex flex-col justify-between">
            <div class="flex items-center justify-between gap-2">
...
<div class="mt-8 grid gap-6 xl:grid-cols-3">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm xl:col-span-2 overflow-hidden hover:shadow-md transition">
        <div class="px-6 py-5 border-b border-slate-50 flex items-center justify-between">
            ...
            <a href="hr_applications.php" class="text-xs font-bold text-blue-600 hover:text-blue-800 hover:underline">View all</a>
        </div>
