...
include_once __DIR__ . '/hr_module_helpers.php';
...
page_shell_start('confirmation_template', 'Confirmation Letter Template', 'Define, modify and preview dynamic selection letter templates.');
?>
