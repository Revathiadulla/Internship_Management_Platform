...
<body class="min-h-screen flex font-sans">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 p-6 flex flex-col fixed h-screen z-50">
        ...
        <nav class="flex-1 space-y-1">
            <a href="/IMP/company/dashboard.php" class="sidebar-link active">
                <span class="material-symbols-outlined text-xl">dashboard</span>
                Hiring Overview
            </a>
            <a href="/IMP/company/browse_talent_pool.php" class="sidebar-link">
        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <header class="flex justify-between items-center bg-white p-4 rounded-2xl border border-gray-200 shadow-sm mb-8">
                <div class="flex items-center gap-4 px-2">
                    ...
                    <input type="text" onclick="window.location.href='/IMP/company/browse_talent_pool.php'" placeholder="Search talent pool..." class="bg-transparent border-none text-sm focus:ring-0 w-80 cursor-pointer">
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                ...
                <div class="flex gap-3">
                    <button onclick="window.location.href='/IMP/company/browse_talent_pool.php'" class="bg-blue-600 text-white px-6 py-3 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all">
            ...
            <?php if ($show_limit_warning): ?>
                <div class="p-4 bg-amber-50 border border-amber-200 text-amber-800 text-sm font-semibold rounded-2xl flex items-center gap-3">
                    ...
                    <span>Your subscription is close to its profile viewing limit. <a href="/IMP/company/subscription.php" class="text-blue-600 hover:underline">Upgrade your plan now</a>.</span>
                </div>
            <?php endif; ?>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="/IMP/company/subscription.php" class="bg-gray-150 hover:bg-gray-200 text-gray-800 px-4 py-2.5 rounded-xl text-xs font-bold transition-all">
                        Upgrade / Change Plan
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                        ...
                        <div class="space-y-2">
                            <button onclick="window.location.href='/IMP/company/browse_talent_pool.php'" class="w-full text-left p-3 hover:bg-blue-50 rounded-xl transition-all flex items-center gap-3 group border border-transparent hover:border-blue-100">
                            ...
                            <button onclick="window.location.href='/IMP/company/browse_talent_pool.php?filter=shortlist'" class="w-full text-left p-3 hover:bg-blue-50 rounded-xl transition-all flex items-center gap-3 group border border-transparent hover:border-blue-100">
