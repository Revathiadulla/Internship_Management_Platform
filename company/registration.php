    ...
    <div class="flex-1 flex flex-col lg:flex-row">
        ...
        <div class="lg:w-7/12 bg-white p-8 lg:p-20 flex flex-col">
            <div class="max-w-2xl w-full mx-auto">
                ...
                <form method="POST" action="/IMP/company/registration.php" class="space-y-6">
                    ...
                    <div class="text-center pt-8">
                        <p class="text-sm text-gray-500 font-medium">Already have an account? <a href="/IMP/login.php" class="text-blue-600 font-bold hover:underline">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
