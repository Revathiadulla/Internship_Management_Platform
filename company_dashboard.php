                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        <button id="profile-toggle" class="flex items-center gap-3 rounded-lg px-2 py-1.5 hover:bg-slate-50 transition-colors cursor-pointer text-left">
                            <span class="grid h-9 w-9 place-items-center rounded-full bg-blue-600 text-sm font-bold text-white"><?php echo strtoupper(substr($recruiter_name, 0, 1)); ?></span>
                            <span class="hidden text-left lg:block">
                                <span class="block text-sm font-bold text-slate-900"><?php echo htmlspecialchars($recruiter_name); ?></span>
                                <span class="block text-xs text-slate-500"><?php echo htmlspecialchars($company_title); ?> Recruiter</span>
                            </span>
                        ...
                        <div id="profile-dropdown" class="hidden absolute right-0 mt-2 min-w-[220px] bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50">
                            <div class="border-b border-slate-100 px-4 py-3 bg-slate-50/50">
                                <p class="text-sm font-bold text-slate-800"><?php echo htmlspecialchars($recruiter_name); ?></p>
                                <p class="truncate text-xs text-slate-400 mt-0.5"><?php echo htmlspecialchars($_SESSION['email'] ?? ''); ?></p>
                                <span class="inline-block px-2 py-0.5 bg-blue-100 text-blue-700 text-[9px] font-extrabold rounded uppercase mt-1.5 tracking-wider">Recruiter</span>
                            </div>
